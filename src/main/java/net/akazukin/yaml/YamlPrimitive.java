...
import net.akazukin.yaml.object.LazilyParsedNumber;
...
/**
 * A class representing a YAML primitive value. A primitive value
...
public final class YamlPrimitive extends YamlElement {
    ...
    public YamlPrimitive(Character c) {
        // convert characters to strings since in YAML, characters are represented as a single
        // character string
